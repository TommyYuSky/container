...
TOP = "for i in {1..20}; do top -c -bn 2 -d 0.01 | grep 'iperf3 -s\|iperf3 -u' | gawk '{ if( $13 == \"-s\") {sum1+=$9; sum2+=$10} else if($13 == \"-b\") {sum3+=$9; sum4+=$10} } END {print sum1, sum2, sum3, sum4}'; sleep 1; done"
if debug == 1:
	print TOP+"\n"
